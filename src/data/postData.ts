...
const PostData = [
    ...
    id: "just-jesus",
    title: "Just Jesus",
    content:"Pastor Adam Smallcombe brings a fresh start to our March series, Christ Alone, from our San Jose campus. How can Jesus be the only way to get right with God? Find out as you open your Bible to Colossians 1 and press play on this week's message Just Jesus",
    date: "2024-03-03",
